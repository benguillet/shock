...
cd /Users/tartopom/Dropbox/Projects/perso/shock && RAILS_ENV=development bundle exec rake earthquake:import --silent >> ~/Dropbox/Projects/perso/shock/logs/import.log 2>&1
